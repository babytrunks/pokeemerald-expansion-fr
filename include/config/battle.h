...
#define B_APPLY_DNS_TO_BACKGROUND           FALSE     // Applies the day and night system to the background during battles (assuming the current map is also affected)
...
#define B_SPRITE_BLEND_LEVEL                0      // How much the DNS blending affects the sprites on a 0-100 scale. 100 is fully applied DNS, 0 is no DNS blending at all
...
#define B_SHOW_BATTLE_INFO_BUTTON   TRUE       // If TRUE, shows an R button prompt during Trainer Battles indicating R can be pressed for battle info
