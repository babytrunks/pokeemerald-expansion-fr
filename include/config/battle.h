...
#define B_PARALYSIS_IMMOBILITY_DENOM 8         // A paralyzed Pokémon is fully paralyzed 1 turn in this many. Gens 1-9 use 4 (25%); Pokémon Champions uses 8 (12.5%).
...
#define B_SLEEP_TURNS_MAX_TWO       TRUE       // Pokémon Champions: sleep lasts 1-2 turns, with a 1/3 chance of waking up on the second turn. Takes precedence over B_SLEEP_TURNS.
...
#define B_FLAG_NO_CATCHING          FLAG_CANT_CATCH     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           FLAG_CANT_RUN     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
...
#define B_FLAG_NO_EXP               FLAG_DISABLE_EXP // If this flag is set, no EXP is awarded. Used by scripted battles like the puzzle battle where levelling up mid fight would change the puzzle.
