...
#define HGSS_SHOW_EGG_MOVES                 FALSE // If FALSE, Egg Moves are left out of the move list entirely.
#define HGSS_SHOW_EGG_MOVES_FOR_EVOS        FALSE  // If TRUE, shows Egg Moves for evolved Pokémon too. Requires HGSS_SHOW_EGG_MOVES.
