...
#define OUTFIT_ALT_RED_GREEN 2
#define OUTFIT_GOLD_KRIS 3
#define OUTFIT_LUCAS_DAWN 4
#define OUTFIT_ALAIN_LYRA 5
#define OUTFIT_PLACEHOLDER_1 6
#define OUTFIT_PLACEHOLDER_2 7
#define OUTFIT_PLACEHOLDER_3 8
#define OUTFIT_PLACEHOLDER_4 9
#define OUTFIT_COUNT 10

// inclusive
#define OUTFIT_BEGIN OUTFIT_USUAL_GREEN
#define OUTFIT_END   OUTFIT_PLACEHOLDER_1
