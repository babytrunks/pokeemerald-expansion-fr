...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_STRIKER = 311,
    ABILITY_FATAL_PRECISION = 312,
    ABILITY_SELF_SUFFICIENT = 313,
    ABILITY_SAGE_POWER = 314,
    ABILITY_BONE_ZONE = 315,
    ABILITY_MOUNTAINEER = 316,
    ABILITY_PHOENIX_DOWN = 317,
    ...
    ABILITY_LAST_KISS = 333, // Healing Wish + revival on faint, once per battle per side
