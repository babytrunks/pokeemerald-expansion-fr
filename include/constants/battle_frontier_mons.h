...
#define STARTER_SELECTION 0
#define GRASS_SELECTION 1

// Trainer School Selection
...
#define FRONTIER_MON_TURTWIG        6
#define FRONTIER_MON_CHIMCHAR       7
#define FRONTIER_MON_PIPLUP         8
#define FRONTIER_MON_SNIVY          9
#define FRONTIER_MON_TEPIG          10
#define FRONTIER_MON_OSHAWOTT       11
#define FRONTIER_MON_CHESPIN        12
#define FRONTIER_MON_FENNEKIN       13
#define FRONTIER_MON_FROAKIE        14
#define FRONTIER_MON_ROWLET         15
#define FRONTIER_MON_LITTEN         16
#define FRONTIER_MON_POPPLIO        17
#define FRONTIER_MON_GROOKEY        18
#define FRONTIER_MON_SCORBUNNY      19
#define FRONTIER_MON_SOBBLE         20
...
#define FRONTIER_MON_BELLSPROUT     (FRONTIER_MON_MUDKIP + 2)
#define FRONTIER_MON_SNOVER         (FRONTIER_MON_MUDKIP + 3)
#define FRONTIER_MON_BUDEW          (FRONTIER_MON_MUDKIP + 4)   
#define FRONTIER_MON_VOLTORB_HISUIAN   (FRONTIER_MON_MUDKIP + 5)
#define FRONTIER_MON_CARNIVINE      (FRONTIER_MON_MUDKIP + 6)
#define FRONTIER_MON_COTTONEE       (FRONTIER_MON_MUDKIP + 7)
#define FRONTIER_MON_PETILIL        (FRONTIER_MON_MUDKIP + 8)
#define FRONTIER_MON_MARACTUS       (FRONTIER_MON_MUDKIP + 9)
#define FRONTIER_MON_APPLIN         (FRONTIER_MON_MUDKIP + 10)
#define FRONTIER_MON_FOONGUS        (FRONTIER_MON_MUDKIP + 11)
#define FRONTIER_MON_TROPIUS        (FRONTIER_MON_MUDKIP + 12)
#define FRONTIER_MON_TOEDSCOOL      (FRONTIER_MON_MUDKIP + 13)
#define FRONTIER_MON_EXEGGCUTE      (FRONTIER_MON_MUDKIP + 14)
#define FRONTIER_MON_LILEEP         (FRONTIER_MON_MUDKIP + 15)
#define FRONTIER_MON_CAPSAKID       (FRONTIER_MON_MUDKIP + 16)
#define FRONTIER_MON_DHELMISE       (FRONTIER_MON_MUDKIP + 17)

// Bugsy Beat Mon Selection
// Last of previous section: FRONTIER_MON_DHELMISE
#define FRONTIER_MON_SCYTHER        (FRONTIER_MON_DHELMISE + 1)
#define FRONTIER_MON_NYMBLE         (FRONTIER_MON_DHELMISE + 2)
#define FRONTIER_MON_PINSIR         (FRONTIER_MON_DHELMISE + 3)
#define FRONTIER_MON_HERACROSS      (FRONTIER_MON_DHELMISE + 4)
#define FRONTIER_MON_SHUCKLE        (FRONTIER_MON_DHELMISE + 5)
#define FRONTIER_MON_ANORITH        (FRONTIER_MON_DHELMISE + 6)
#define FRONTIER_MON_SKORUPI        (FRONTIER_MON_DHELMISE + 7)
#define FRONTIER_MON_VENIPEDE       (FRONTIER_MON_DHELMISE + 8)
#define FRONTIER_MON_KARRABLAST     (FRONTIER_MON_DHELMISE + 9)
#define FRONTIER_MON_SHELMET        (FRONTIER_MON_DHELMISE + 10)
#define FRONTIER_MON_DURANT         (FRONTIER_MON_DHELMISE + 11)
#define FRONTIER_MON_LARVESTA       (FRONTIER_MON_DHELMISE + 12)
#define FRONTIER_MON_WIMPOD         (FRONTIER_MON_DHELMISE + 13)
#define FRONTIER_MON_DEWPIDER       (FRONTIER_MON_DHELMISE + 14)
#define FRONTIER_MON_FALINKS        (FRONTIER_MON_DHELMISE + 15)
// #define FRONTIER_MON_ZANGOOSE       (FRONTIER_MON_DHELMISE + 16)
// #define FRONTIER_MON_MINCCINO       (FRONTIER_MON_DHELMISE + 17)
// #define FRONTIER_MON_DRAMPA         (FRONTIER_MON_DHELMISE + 18)
// #define FRONTIER_MON_CYCLIZAR       (FRONTIER_MON_DHELMISE + 19)
// #define FRONTIER_MON_GIRAFARIG      (FRONTIER_MON_DHELMISE + 20)
// #define FRONTIER_MON_INDEEDEE_M     (FRONTIER_MON_DHELMISE + 21)
// #define FRONTIER_MON_SWABLU         (FRONTIER_MON_DHELMISE + 22)
// #define FRONTIER_MON_KECLEON        (FRONTIER_MON_DHELMISE + 23)
// #define FRONTIER_MON_TOGEPI         (FRONTIER_MON_DHELMISE + 24)

// Sevii Mons Mon Selection
// Last of previous section: FRONTIER_MON_FALINKS
#define FRONTIER_MON_BLITZLE_SEVII     (FRONTIER_MON_FALINKS + 1)
#define FRONTIER_MON_NOIBAT_SEVII      (FRONTIER_MON_FALINKS + 2)
#define FRONTIER_MON_FEEBAS_SEVII      (FRONTIER_MON_FALINKS + 3)
#define FRONTIER_MON_SIZZLIPEDE_SEVII  (FRONTIER_MON_FALINKS + 4)
#define FRONTIER_MON_TEDDIURSA_SEVII   (FRONTIER_MON_FALINKS + 5)
#define FRONTIER_MON_NYMBLE_SEVII      (FRONTIER_MON_FALINKS + 6)
#define FRONTIER_MON_DODUO_SEVII       (FRONTIER_MON_FALINKS + 7)
#define FRONTIER_MON_MANTYKE_SEVII     (FRONTIER_MON_FALINKS + 8)
#define FRONTIER_MON_CARNIVINE_SEVII   (FRONTIER_MON_FALINKS + 9)
#define FRONTIER_MON_CLAUNCHER_SEVII   (FRONTIER_MON_FALINKS + 10)
#define FRONTIER_MON_WISHIWASHI_SEVII  (FRONTIER_MON_FALINKS + 11)
#define FRONTIER_MON_DHELMISE_SEVII    (FRONTIER_MON_FALINKS + 12)


// Route 103 Fisherman Rare mons, removed. But can use for later
// Last of previous section: FRONTIER_MON_DHELMISE_SEVII
#define FRONTIER_MON_CARVANHA       (FRONTIER_MON_DHELMISE_SEVII + 1)
#define FRONTIER_MON_CORPHISH       (FRONTIER_MON_DHELMISE_SEVII + 2)
#define FRONTIER_MON_PSYDUCK        (FRONTIER_MON_DHELMISE_SEVII + 3)
#define FRONTIER_MON_FINIZEN        (FRONTIER_MON_DHELMISE_SEVII + 4)
#define FRONTIER_MON_SEEL           (FRONTIER_MON_DHELMISE_SEVII + 5)
#define FRONTIER_MON_SPHEAL         (FRONTIER_MON_DHELMISE_SEVII + 6)
#define FRONTIER_MON_KRABBY         (FRONTIER_MON_DHELMISE_SEVII + 7)
#define FRONTIER_MON_SLOWPOKE       (FRONTIER_MON_DHELMISE_SEVII + 8)
#define FRONTIER_MON_SHELLDER       (FRONTIER_MON_DHELMISE_SEVII + 9)
#define FRONTIER_MON_MANTYKE        (FRONTIER_MON_DHELMISE_SEVII + 10)
#define FRONTIER_MON_CLAMPERL       (FRONTIER_MON_DHELMISE_SEVII + 11)
#define FRONTIER_MON_LUVDISC        (FRONTIER_MON_DHELMISE_SEVII + 12)
#define FRONTIER_MON_BUIZEL         (FRONTIER_MON_DHELMISE_SEVII + 13)
#define FRONTIER_MON_BASCULIN       (FRONTIER_MON_DHELMISE_SEVII + 14)
#define FRONTIER_MON_FRILLISH       (FRONTIER_MON_DHELMISE_SEVII + 15)
#define FRONTIER_MON_WISHIWASHI     (FRONTIER_MON_DHELMISE_SEVII + 16)
#define FRONTIER_MON_MAREANIE       (FRONTIER_MON_DHELMISE_SEVII + 17)
// #define FRONTIER_MON_DEWPIDER       (FRONTIER_MON_DHELMISE_SEVII + 18)
#define FRONTIER_MON_HORSEA         (FRONTIER_MON_DHELMISE_SEVII + 18)
#define FRONTIER_MON_ALOMOMOLA      (FRONTIER_MON_DHELMISE_SEVII + 19)
#define FRONTIER_MON_STARYU         (FRONTIER_MON_DHELMISE_SEVII + 20)
#define FRONTIER_MON_LAPRAS         (FRONTIER_MON_DHELMISE_SEVII + 21)
#define FRONTIER_MON_SLOWPOKE_GALAR (FRONTIER_MON_DHELMISE_SEVII + 22)

// Celadon City Give Mon
// Last of previous section: FRONTIER_MON_SLOWPOKE_GALAR
#define FRONTIER_MON_DRATINI        (FRONTIER_MON_SLOWPOKE_GALAR + 1)
#define FRONTIER_MON_LARVITAR         (FRONTIER_MON_SLOWPOKE_GALAR + 2)
#define FRONTIER_MON_BAGON         (FRONTIER_MON_SLOWPOKE_GALAR + 3)
#define FRONTIER_MON_BELDUM       (FRONTIER_MON_SLOWPOKE_GALAR + 4)
#define FRONTIER_MON_DEINO       (FRONTIER_MON_SLOWPOKE_GALAR + 5)
#define FRONTIER_MON_GOOMY       (FRONTIER_MON_SLOWPOKE_GALAR + 6)
#define FRONTIER_MON_JANGMO_O         (FRONTIER_MON_SLOWPOKE_GALAR + 7)
#define FRONTIER_MON_DREEPY         (FRONTIER_MON_SLOWPOKE_GALAR + 8)
#define FRONTIER_MON_FRIGIBAX         (FRONTIER_MON_SLOWPOKE_GALAR + 9)


// Devon Corp Give Mon (Rustboro City after saving Peeko)
// Last of previous section: FRONTIER_MON_SWINUB
#define FRONTIER_MON_HOUNDOUR       (FRONTIER_MON_FRIGIBAX + 1)
#define FRONTIER_MON_MURKROW        (FRONTIER_MON_FRIGIBAX + 2)
#define FRONTIER_MON_SNEASEL        (FRONTIER_MON_FRIGIBAX + 3)
#define FRONTIER_MON_ABSOL          (FRONTIER_MON_FRIGIBAX + 4)
#define FRONTIER_MON_CARVANHA_1     (FRONTIER_MON_FRIGIBAX + 5)
#define FRONTIER_MON_SPIRITOMB      (FRONTIER_MON_FRIGIBAX + 6)
#define FRONTIER_MON_SANDILE        (FRONTIER_MON_FRIGIBAX + 7)
#define FRONTIER_MON_PAWNIARD       (FRONTIER_MON_FRIGIBAX + 8)
#define FRONTIER_MON_VULLABY        (FRONTIER_MON_FRIGIBAX + 9)
#define FRONTIER_MON_IMPIDIMP       (FRONTIER_MON_FRIGIBAX + 10)
#define FRONTIER_MON_MORPEKO        (FRONTIER_MON_FRIGIBAX + 11)
#define FRONTIER_MON_SCRAGGY        (FRONTIER_MON_FRIGIBAX + 12)
#define FRONTIER_MON_KUBFU          (FRONTIER_MON_FRIGIBAX + 13)
#define FRONTIER_MON_LITTEN_1       (FRONTIER_MON_FRIGIBAX + 14)
#define FRONTIER_MON_SPRIGATITO_1   (FRONTIER_MON_FRIGIBAX + 15)
#define FRONTIER_MON_FLOETTE_ETERNAL (FRONTIER_MON_FRIGIBAX + 16)
#define FRONTIER_MON_ZORUA          (FRONTIER_MON_FRIGIBAX + 17)
#define FRONTIER_MON_ZORUA_HISUI    (FRONTIER_MON_FRIGIBAX + 18)
// #define FRONTIER_MON_LARVITAR       (FRONTIER_MON_FRIGIBAX + 19)
// #define FRONTIER_MON_DEINO          (FRONTIER_MON_FRIGIBAX + 20)

// Signature Move Give Mon Selection
// Last of previous section: FRONTIER_MON_ZORUA_HISUI
#define FRONTIER_MON_ALTARIA_SIG         (FRONTIER_MON_ZORUA_HISUI + 1)
#define FRONTIER_MON_CLOYSTER_SIG        (FRONTIER_MON_ZORUA_HISUI + 2)
#define FRONTIER_MON_CLEFABLE_SIG        (FRONTIER_MON_ZORUA_HISUI + 3)
#define FRONTIER_MON_KINGDRA_SIG         (FRONTIER_MON_ZORUA_HISUI + 4)
#define FRONTIER_MON_GARCHOMP_SIG        (FRONTIER_MON_ZORUA_HISUI + 5)
#define FRONTIER_MON_LILLIGANT_HISUI_SIG (FRONTIER_MON_ZORUA_HISUI + 6)
#define FRONTIER_MON_MAGCARGO_SIG        (FRONTIER_MON_ZORUA_HISUI + 7)
#define FRONTIER_MON_MAWILE_SIG          (FRONTIER_MON_ZORUA_HISUI + 8)
#define FRONTIER_MON_SHUCKLE_SIG         (FRONTIER_MON_ZORUA_HISUI + 9)
#define FRONTIER_MON_ROSERADE_SIG        (FRONTIER_MON_ZORUA_HISUI + 10)
#define FRONTIER_MON_DRAMPA_SIG          (FRONTIER_MON_ZORUA_HISUI + 11)
#define FRONTIER_MON_DOUBLADE_SIG        (FRONTIER_MON_ZORUA_HISUI + 12)
#define FRONTIER_MON_HERACROSS_SIG       (FRONTIER_MON_ZORUA_HISUI + 13)
#define FRONTIER_MON_METAGROSS_SIG       (FRONTIER_MON_ZORUA_HISUI + 14)
#define FRONTIER_MON_MEDICHAM_SIG        (FRONTIER_MON_ZORUA_HISUI + 15)
#define FRONTIER_MON_VOLCARONA_SIG       (FRONTIER_MON_ZORUA_HISUI + 16)
#define FRONTIER_MON_GYARADOS_SIG        (FRONTIER_MON_ZORUA_HISUI + 17)
#define FRONTIER_MON_MEGANIUM_SIG        (FRONTIER_MON_ZORUA_HISUI + 18)
#define FRONTIER_MON_LUXRAY_SIG          (FRONTIER_MON_ZORUA_HISUI + 19)
#define FRONTIER_MON_DRAGONITE_SIG       (FRONTIER_MON_ZORUA_HISUI + 20)
#define FRONTIER_MON_DUSKNOIR_SIG        (FRONTIER_MON_ZORUA_HISUI + 21)
#define FRONTIER_MON_SCIZOR_SIG          (FRONTIER_MON_ZORUA_HISUI + 22)
#define FRONTIER_MON_GARDEVOIR_SIG       (FRONTIER_MON_ZORUA_HISUI + 23)
#define FRONTIER_MON_TYRANITAR_SIG       (FRONTIER_MON_ZORUA_HISUI + 24)
#define FRONTIER_MON_NOIVERN_SIG         (FRONTIER_MON_ZORUA_HISUI + 25)
#define FRONTIER_MON_DRAGAPULT_SIG       (FRONTIER_MON_ZORUA_HISUI + 26)
#define FRONTIER_MON_ELECTRODE_SIG       (FRONTIER_MON_ZORUA_HISUI + 27)
#define FRONTIER_MON_ABSOL_SIG           (FRONTIER_MON_ZORUA_HISUI + 28)


#define FRONTIER_MON_OMANYTE        800
#define FRONTIER_MON_KABUTO         801
#define FRONTIER_MON_LILEEP_2       802
#define FRONTIER_MON_SHIELDON       803
#define FRONTIER_MON_CRANIDOS       804
#define FRONTIER_MON_TIRTOUGA       805
#define FRONTIER_MON_ARCHEN         806
#define FRONTIER_MON_TYRUNT         807
#define FRONTIER_MON_AMAURA         808
#define FRONTIER_MON_AERODACTYL     809
#define FRONTIER_MON_GLIMMET        810
#define FRONTIER_MON_CORSOLA_GALAR  811
#define FRONTIER_MON_RELICANTH      812
#define FRONTIER_MON_SWINUB         900

#define FRONTIER_MON_TYROGUE        906
#define FRONTIER_MON_KECLEON        907
#define FRONTIER_MON_SMEARGLE       908
#define FRONTIER_MON_WYNAUT         909
#define FRONTIER_MON_SKITTY         910
#define FRONTIER_MON_JIGGLYPUFF     911
#define FRONTIER_MON_WINGULL        912
#define FRONTIER_MON_NIDORAN_M      913
#define FRONTIER_MON_NIDORAN_F      914
#define FRONTIER_MON_KIRLIA         915
#define FRONTIER_MON_MAREEP         916
#define FRONTIER_MON_MEDITITE       917

#define FRONTIER_MON_PARAS          918

#define FRONTIER_MON_DITTO          919

#define FRONTIER_MON_MEOWTH         920
#define FRONTIER_MON_TRAPINCH       921



#define FRONTIER_MON_DUSKULL        899
#define FRONTIER_MON_ELECTRIKE      923
#define FRONTIER_MON_VULPIX         924

#define FRONTIER_MON_SANDSHREW      925
#define FRONTIER_MON_POLIWAG        926
#define FRONTIER_MON_GEODUDE        928
// #define FRONTIER_MON_DRATINI        929
#define FRONTIER_MON_SNUBBULL       930
#define FRONTIER_MON_REMORAID       931
#define FRONTIER_MON_BALTOY         933
#define FRONTIER_MON_SNORUNT        934
// #define FRONTIER_MON_BAGON          935
// #define FRONTIER_MON_BELDUM         936
#define FRONTIER_MON_GULPIN         937
#define FRONTIER_MON_VENONAT        938
...
#define FRONTIER_MON_ABRA       191
#define FRONTIER_MON_MANKEY    192
#define FRONTIER_MON_YANMA    193
