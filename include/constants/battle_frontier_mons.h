...
#define FRONTIER_MON_SHELMET        (FRONTIER_MON_MUDKIP + 5)
#define FRONTIER_MON_MAGIKARP       (FRONTIER_MON_MUDKIP + 6)
#define FRONTIER_MON_LARVESTA       (FRONTIER_MON_MUDKIP + 7)
#define FRONTIER_MON_KARRABLAST     (FRONTIER_MON_MUDKIP + 8)
#define FRONTIER_MON_WOOPER_P       (FRONTIER_MON_MUDKIP + 9)
#define FRONTIER_MON_SNOM           (FRONTIER_MON_MUDKIP + 10)
#define FRONTIER_MON_PINECO         (FRONTIER_MON_MUDKIP + 11)
#define FRONTIER_MON_VENIPEDE       (FRONTIER_MON_MUDKIP + 12)
#define FRONTIER_MON_WOOPER         (FRONTIER_MON_MUDKIP + 13)
#define FRONTIER_MON_WIMPOD         (FRONTIER_MON_MUDKIP + 14)
#define FRONTIER_MON_FEEBAS         (FRONTIER_MON_MUDKIP + 15)
#define FRONTIER_MON_SKORUPI        (FRONTIER_MON_MUDKIP + 16)
#define FRONTIER_MON_FOONGUS        (FRONTIER_MON_MUDKIP + 17)
#define FRONTIER_MON_TROPIUS        (FRONTIER_MON_MUDKIP + 18)
#define FRONTIER_MON_BUDEW          (FRONTIER_MON_MUDKIP + 19)
#define FRONTIER_MON_TOEDSCOOL      (FRONTIER_MON_MUDKIP + 20)
#define FRONTIER_MON_EXEGGCUTE      (FRONTIER_MON_MUDKIP + 21)
#define FRONTIER_MON_HERACROSS      (FRONTIER_MON_MUDKIP + 22)
#define FRONTIER_MON_DHELMISE       (FRONTIER_MON_MUDKIP + 23)

// Petalburg City Rare Mons
// Last of previous section: FRONTIER_MON_DHELMISE
#define FRONTIER_MON_TYROGUE        (FRONTIER_MON_DHELMISE + 1)
#define FRONTIER_MON_AZURILL        (FRONTIER_MON_DHELMISE + 2)
#define FRONTIER_MON_IGGLYBUFF      (FRONTIER_MON_DHELMISE + 3)
#define FRONTIER_MON_MUNCHLAX       (FRONTIER_MON_DHELMISE + 4)
#define FRONTIER_MON_STUFFUL        (FRONTIER_MON_DHELMISE + 5)
#define FRONTIER_MON_BUNEARY        (FRONTIER_MON_DHELMISE + 6)
#define FRONTIER_MON_LICKITUNG      (FRONTIER_MON_DHELMISE + 7)
#define FRONTIER_MON_EEVEE_2        (FRONTIER_MON_DHELMISE + 8)
#define FRONTIER_MON_PORYGON        (FRONTIER_MON_DHELMISE + 9)
#define FRONTIER_MON_CLEFFA         (FRONTIER_MON_DHELMISE + 10)
#define FRONTIER_MON_DUNSPARCE      (FRONTIER_MON_DHELMISE + 11)
#define FRONTIER_MON_TEDDIURSA      (FRONTIER_MON_DHELMISE + 12)
#define FRONTIER_MON_STANTLER       (FRONTIER_MON_DHELMISE + 13)
#define FRONTIER_MON_TANDEMAUS      (FRONTIER_MON_DHELMISE + 14)
#define FRONTIER_MON_HAPPINY        (FRONTIER_MON_DHELMISE + 15)
...
// Last of previous section: FRONTIER_MON_TOGEPI
#define FRONTIER_MON_CARVANHA       (FRONTIER_MON_TOGEPI + 1)
#define FRONTIER_MON_CORPHISH       (FRONTIER_MON_TOGEPI + 2)
#define FRONTIER_MON_PSYDUCK        (FRONTIER_MON_TOGEPI + 3)
#define FRONTIER_MON_FINIZEN        (FRONTIER_MON_TOGEPI + 4)
#define FRONTIER_MON_SEEL           (FRONTIER_MON_TOGEPI + 5)
#define FRONTIER_MON_SPHEAL         (FRONTIER_MON_TOGEPI + 6)
#define FRONTIER_MON_KRABBY         (FRONTIER_MON_TOGEPI + 7)
#define FRONTIER_MON_SLOWPOKE       (FRONTIER_MON_TOGEPI + 8)
#define FRONTIER_MON_SHELLDER       (FRONTIER_MON_TOGEPI + 9)
#define FRONTIER_MON_MANTYKE        (FRONTIER_MON_TOGEPI + 10)
#define FRONTIER_MON_CLAMPERL       (FRONTIER_MON_TOGEPI + 11)
#define FRONTIER_MON_LUVDISC        (FRONTIER_MON_TOGEPI + 12)
#define FRONTIER_MON_BUIZEL         (FRONTIER_MON_TOGEPI + 13)
#define FRONTIER_MON_BASCULIN       (FRONTIER_MON_TOGEPI + 14)
#define FRONTIER_MON_FRILLISH       (FRONTIER_MON_TOGEPI + 15)
#define FRONTIER_MON_WISHIWASHI     (FRONTIER_MON_TOGEPI + 16)
#define FRONTIER_MON_MAREANIE       (FRONTIER_MON_TOGEPI + 17)
#define FRONTIER_MON_DEWPIDER       (FRONTIER_MON_TOGEPI + 18)
#define FRONTIER_MON_HORSEA         (FRONTIER_MON_TOGEPI + 19)
#define FRONTIER_MON_ALOMOMOLA      (FRONTIER_MON_TOGEPI + 20)
#define FRONTIER_MON_STARYU         (FRONTIER_MON_TOGEPI + 21)
#define FRONTIER_MON_LAPRAS         (FRONTIER_MON_TOGEPI + 22)
#define FRONTIER_MON_SLOWPOKE_GALAR (FRONTIER_MON_TOGEPI + 23)

// Devon Corp Rustboro Give Mon
// Last of previous section: FRONTIER_MON_SLOWPOKE_GALAR
#define FRONTIER_MON_OMANYTE        (FRONTIER_MON_SLOWPOKE_GALAR + 1)
#define FRONTIER_MON_KABUTO         (FRONTIER_MON_SLOWPOKE_GALAR + 2)
#define FRONTIER_MON_LILEEP         (FRONTIER_MON_SLOWPOKE_GALAR + 3)
#define FRONTIER_MON_ANORITH        (FRONTIER_MON_SLOWPOKE_GALAR + 4)
#define FRONTIER_MON_SHIELDON       (FRONTIER_MON_SLOWPOKE_GALAR + 5)
#define FRONTIER_MON_CRANIDOS       (FRONTIER_MON_SLOWPOKE_GALAR + 6)
#define FRONTIER_MON_TIRTOUGA       (FRONTIER_MON_SLOWPOKE_GALAR + 7)
#define FRONTIER_MON_ARCHEN         (FRONTIER_MON_SLOWPOKE_GALAR + 8)
#define FRONTIER_MON_TYRUNT         (FRONTIER_MON_SLOWPOKE_GALAR + 9)
#define FRONTIER_MON_AMAURA         (FRONTIER_MON_SLOWPOKE_GALAR + 10)
#define FRONTIER_MON_AERODACTYL     (FRONTIER_MON_SLOWPOKE_GALAR + 11)
#define FRONTIER_MON_GLIMMET        (FRONTIER_MON_SLOWPOKE_GALAR + 12)
#define FRONTIER_MON_CORSOLA_GALAR  (FRONTIER_MON_SLOWPOKE_GALAR + 13)
#define FRONTIER_MON_RELICANTH      (FRONTIER_MON_SLOWPOKE_GALAR + 14)
#define FRONTIER_MON_SWINUB         (FRONTIER_MON_SLOWPOKE_GALAR + 15)

// Devon Corp Give Mon (Rustboro City after saving Peeko)
// Last of previous section: FRONTIER_MON_SWINUB
#define FRONTIER_MON_HOUNDOUR       (FRONTIER_MON_SWINUB + 1)
#define FRONTIER_MON_MURKROW        (FRONTIER_MON_SWINUB + 2)
#define FRONTIER_MON_SNEASEL        (FRONTIER_MON_SWINUB + 3)
#define FRONTIER_MON_ABSOL          (FRONTIER_MON_SWINUB + 4)
#define FRONTIER_MON_CARVANHA_1     (FRONTIER_MON_SWINUB + 5)
#define FRONTIER_MON_SPIRITOMB      (FRONTIER_MON_SWINUB + 6)
#define FRONTIER_MON_SANDILE        (FRONTIER_MON_SWINUB + 7)
#define FRONTIER_MON_PAWNIARD       (FRONTIER_MON_SWINUB + 8)
#define FRONTIER_MON_VULLABY        (FRONTIER_MON_SWINUB + 9)
#define FRONTIER_MON_IMPIDIMP       (FRONTIER_MON_SWINUB + 10)
#define FRONTIER_MON_MORPEKO        (FRONTIER_MON_SWINUB + 11)
#define FRONTIER_MON_SCRAGGY        (FRONTIER_MON_SWINUB + 12)
#define FRONTIER_MON_KUBFU          (FRONTIER_MON_SWINUB + 13)
#define FRONTIER_MON_LITTEN_1       (FRONTIER_MON_SWINUB + 14)
#define FRONTIER_MON_SPRIGATITO_1   (FRONTIER_MON_SWINUB + 15)
#define FRONTIER_MON_FLOETTE_ETERNAL (FRONTIER_MON_SWINUB + 16)
#define FRONTIER_MON_ZORUA          (FRONTIER_MON_SWINUB + 17)
#define FRONTIER_MON_ZORUA_HISUI    (FRONTIER_MON_SWINUB + 18)
#define FRONTIER_MON_LARVITAR       (FRONTIER_MON_SWINUB + 19)
#define FRONTIER_MON_DEINO          (FRONTIER_MON_SWINUB + 20)
...
#define FRONTIER_MON_BELLSPROUT     927
