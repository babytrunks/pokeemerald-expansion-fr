...
#define FRONTIER_MON_LARVITAR         (FRONTIER_MON_SLOWPOKE_GALAR + 1)
#define FRONTIER_MON_BAGON         (FRONTIER_MON_SLOWPOKE_GALAR + 2)
#define FRONTIER_MON_BELDUM       (FRONTIER_MON_SLOWPOKE_GALAR + 3)
#define FRONTIER_MON_DEINO       (FRONTIER_MON_SLOWPOKE_GALAR + 4)
#define FRONTIER_MON_GOOMY       (FRONTIER_MON_SLOWPOKE_GALAR + 5)
#define FRONTIER_MON_JANGMO_O         (FRONTIER_MON_SLOWPOKE_GALAR + 6)
#define FRONTIER_MON_DREEPY         (FRONTIER_MON_SLOWPOKE_GALAR + 7)
#define FRONTIER_MON_FRIGIBAX         (FRONTIER_MON_SLOWPOKE_GALAR + 8)
