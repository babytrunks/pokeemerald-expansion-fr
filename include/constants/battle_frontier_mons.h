...
#define FRONTIER_MON_ABRA           (FRONTIER_MON_MUDKIP + 1)
#define FRONTIER_MON_MANKEY         (FRONTIER_MON_MUDKIP + 2)
#define FRONTIER_MON_YANMA          (FRONTIER_MON_MUDKIP + 3)
#define FRONTIER_MON_PINSIR         (FRONTIER_MON_MUDKIP + 4)
