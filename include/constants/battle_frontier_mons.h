...
#define FRONTIER_MON_CARVANHA       (FRONTIER_MON_FALINKS + 1)
#define FRONTIER_MON_CORPHISH       (FRONTIER_MON_FALINKS + 2)
#define FRONTIER_MON_PSYDUCK        (FRONTIER_MON_FALINKS + 3)
#define FRONTIER_MON_FINIZEN        (FRONTIER_MON_FALINKS + 4)
#define FRONTIER_MON_SEEL           (FRONTIER_MON_FALINKS + 5)
#define FRONTIER_MON_SPHEAL         (FRONTIER_MON_FALINKS + 6)
#define FRONTIER_MON_KRABBY         (FRONTIER_MON_FALINKS + 7)
#define FRONTIER_MON_SLOWPOKE       (FRONTIER_MON_FALINKS + 8)
#define FRONTIER_MON_SHELLDER       (FRONTIER_MON_FALINKS + 9)
#define FRONTIER_MON_MANTYKE        (FRONTIER_MON_FALINKS + 10)
#define FRONTIER_MON_CLAMPERL       (FRONTIER_MON_FALINKS + 11)
#define FRONTIER_MON_LUVDISC        (FRONTIER_MON_FALINKS + 12)
#define FRONTIER_MON_BUIZEL         (FRONTIER_MON_FALINKS + 13)
#define FRONTIER_MON_BASCULIN       (FRONTIER_MON_FALINKS + 14)
#define FRONTIER_MON_FRILLISH       (FRONTIER_MON_FALINKS + 15)
#define FRONTIER_MON_WISHIWASHI     (FRONTIER_MON_FALINKS + 16)
#define FRONTIER_MON_MAREANIE       (FRONTIER_MON_FALINKS + 17)
// #define FRONTIER_MON_DEWPIDER       (FRONTIER_MON_FALINKS + 18)
#define FRONTIER_MON_HORSEA         (FRONTIER_MON_FALINKS + 18)
#define FRONTIER_MON_ALOMOMOLA      (FRONTIER_MON_FALINKS + 19)
#define FRONTIER_MON_STARYU         (FRONTIER_MON_FALINKS + 20)
#define FRONTIER_MON_LAPRAS         (FRONTIER_MON_FALINKS + 21)
#define FRONTIER_MON_SLOWPOKE_GALAR (FRONTIER_MON_FALINKS + 22)
