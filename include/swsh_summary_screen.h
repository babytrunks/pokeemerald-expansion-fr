...
#define SWSH_MAX_ABILITY_DESCRIPTION_LENGTH           128       // buffer for the wrapped ability description on the skills page
...
#define SWSH_SUMMARY_SHOW_LEVEL_CAP                   TRUE      // show the current level cap next to the level, as Lv. 10/14
