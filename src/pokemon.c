...
// 3) repurpose IDs from other items that aren't being used, like ITEM_GOLD_TEETH or ITEM_SLATEPORT_TICKET until ITEMS_COUNT equals 1023, the max value that will fit in 10 bits.
