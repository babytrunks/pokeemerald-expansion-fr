...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_BATTLE_ITEMS] = COMPOUND_STRING("{FONT_SMALL}Battle Items"),
...
const u8 gText_PkmnFriendlyBase[] = _("{STR_VAR_1} turned friendly.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RentalPkmn[] = _("Rare Pokémon");
...
const u8 gText_XNatureObtainedInTrade[] = _("{FONT_SMALL_NARROWER}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nobtained in a trade.");
...
const u8 gText_Treasures[] = _("Mega Stones");
...
const u8 gText_FarawayIsland[] = _("Wishing Isle");
...
const u8 gText_RentalPkmn2[] = _("Rare Pokémon");
const u8 gText_SelectFirstPkmn[] = _("Select a Pokémon.");
...
const u8 gText_RepelEffectsToggledOff[] = _("The fumes from Infinite Repel\nwere smeared off.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepelEffectsToggledOn[] = _("{PLAYER} used the\nInfinite Repel.\pWild Pokémon will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SideQuestName_5[] = _("Rising Tempo");
const u8 gText_SideQuestName_6[] = _("Flutterfree Fan");
const u8 gText_SideQuestName_7[] = _("Crazy Cat Lady");
const u8 gText_SideQuestName_8[] = _("The Blue Rock");
const u8 gText_SideQuestName_9[] = _("Nothing Suspicious Here");
const u8 gText_SideQuestName_10[] = _("The Missing Number");
const u8 gText_SideQuestName_11[] = _("Mega Mayhem");
const u8 gText_SideQuestName_12[] = _("Aria of Sorrow");
const u8 gText_SideQuestName_13[] = _("Ghost in the Machine");
const u8 gText_AFathersRequest2[] = _("Side Quest 12");
const u8 gText_AFathersRequest3[] = _("Side Quest 13");
const u8 gText_AFathersRequest4[] = _("Side Quest 14");
const u8 gText_AFathersRequest5[] = _("Side Quest 15");
const u8 gText_AFathersRequest6[] = _("Side Quest 16");
const u8 gText_AFathersRequest7[] = _("Side Quest 17");
const u8 gText_AFathersRequest8[] = _("Side Quest 18");
const u8 gText_AFathersRequest9[] = _("Side Quest 19");
...
const u8 gText_SideQuestDesc_5[] = _("Show a Pokémon a with perfect IVs\nin Atk, SpA, and Speed.");
const u8 gText_SideQuestDesc_6[] = _("Beat the Flutterfree high score\nof 20!");
const u8 gText_SideQuestDesc_7[] = _("Show the cat lady of Saffron\na feline Pokémon.");
const u8 gText_SideQuestDesc_8[] = _("Show the man at the Route 12\nFishing House the right Pokémon.");
const u8 gText_SideQuestDesc_9[] = _("Retrieve the Rare Extract hidden in\nSilph Co. 7F for the Burglar.");
const u8 gText_SideQuestDesc_10[] = _("Find the grouchy old man's lost lotto\nticket on the east side of Cinnabar.");
const u8 gText_SideQuestDesc_11[] = _("Investigate the rogue Mega Pokémon\nroaming the Safari Zone.");
const u8 gText_SideQuestDesc_12[] = _("Cheer up Azalee's Meloetta by winning\na battle using four Sound moves.");
const u8 gText_SideQuestDesc_13[] = _("Find out what is haunting Silph Co.\nfor the company president.");
...
const u8 gText_SideQuestDoneDesc_5[] = _("Showed a Pokémon with perfect IVs in\nAtk, Def, and Speed to unlock\nseveral boosting Move Tutors.");
const u8 gText_SideQuestDoneDesc_6[] = _("Out-flapped the Flutterfree fan to\nscore Gacha Vouchers.");
const u8 gText_SideQuestDoneDesc_7[] = _("Showed the cat lady a feline\nPokémon and got the Meowsticite.");
const u8 gText_SideQuestDoneDesc_8[] = _("The Blue Rock reacted to\nSharpedo. Got the Sharpedonite.");
const u8 gText_SideQuestDoneDesc_9[] = _("Delivered the Rare Extract for a\nhefty reward.");
const u8 gText_SideQuestDoneDesc_10[] = _("Returned the lotto ticket. The number\ndidn't even match!");
const u8 gText_SideQuestDoneDesc_11[] = _("Subdued the rogue Mega Lucario Z and\ngot the Aerodactylite.");
const u8 gText_SideQuestDoneDesc_12[] = _("Sang Meloetta out of its slump.\nPom let it come along.");
const u8 gText_SideQuestDoneDesc_13[] = _("The ghost was a rival executive.\nMde backed off and left the Garchompite.");
...
const u8 gText_SideQuestMap3[] = _("Oak's Lab");
const u8 gText_SideQuestMap4[] = _("Cerulean City");
const u8 gText_SideQuestMap5[] = _("Vermilion Fan Club");
const u8 gText_SideQuestMap6[] = _("Celadon Game Corner");
const u8 gText_SideQuestMap7[] = _("Saffron City");
const u8 gText_SideQuestMap8[] = _("Route 12");
const u8 gText_SideQuestMap9[] = _("Pokémon Mansion 3F");
const u8 gText_SideQuestMap10[] = _("Viridian City");
const u8 gText_SideQuestMap11[] = _("Cinnabar Labs");
const u8 gText_SideQuestMap12[] = _("Saffron Fan Club");
const u8 gText_SideQuestMap13[] = _("Silph Co. 11F");
...
//subquests
const u8 gText_SubQuest1_Name1[] = _("A Lax Case Study");
const u8 gText_SubQuest1_Name2[] = _("Berry Important");
const u8 gText_SubQuest1_Name3[] = _("Check the Edge Case");
const u8 gText_SubQuest1_Name4[] = _("All Bases Covered");
...
const u8 gText_SubQuest1_Desc1[] = _("Show Oak's Aide a Pokémon with\nLax Nature.");
const u8 gText_SubQuest1_Desc2[] = _("Show Oak's Aide a Persim Berry.");
const u8 gText_SubQuest1_Desc3[] = _("Show Oak's Aide a gender-less Pokémon.");
const u8 gText_SubQuest1_Desc4[] = _("Show Oak's Aide an Everstone.");
