...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_NONE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_BATTLE_ARMOR, ABILITY_DROUGHT },
    #else
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_BATTLE_ARMOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_CHIMECHO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_NONE, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_BLUE,
