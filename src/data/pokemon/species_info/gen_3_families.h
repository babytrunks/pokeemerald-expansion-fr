...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_LINOONE}),
    },
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .formSpeciesIdTable = sZigzagoonFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_1 + 1, SPECIES_LINOONE_GALAR}), //15
    },
    ...
    [SPECIES_LINOONE_GALAR] =
    {
        ...
        .formSpeciesIdTable = sLinooneFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_4, SPECIES_OBSTAGOON, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_SWELLOW}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_KIRLIA}),
    },
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_4, SPECIES_SLAKING}),
    },
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2 + 2, SPECIES_MANECTRIC}),
    },
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_3 + 2, SPECIES_CAMERUPT}),
    },
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_3, SPECIES_GRUMPIG}),
    },
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_3, SPECIES_VIBRAVA}),
    },
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GIOVANNI_CELADON, SPECIES_FLYGON}),
    },
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HYDRATION, ABILITY_HYDRATION, ABILITY_CASH_SPLASH },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_FEEBAS_SEVII] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_OBLIVIOUS, ABILITY_ADAPTABILITY }, // TODO: set SEVII form abilities
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Feebas"),
        .cryId = CRY_FEEBAS,
        .natDexNum = NATIONAL_DEX_FEEBAS,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_FeebasSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
        .backPic = gMonBackPic_FeebasSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SPRING,
        .palette = gMonPalette_FeebasSevii,
        .shinyPalette = gMonShinyPalette_FeebasSevii,
        .iconSprite = gMonIcon_FeebasSevii,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 2, SHADOW_SIZE_S)
        FOOTPRINT(Feebas)
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MILOTIC_SEVII, CONDITIONS({IF_MIN_BEAUTY, 170})},
                                {EVO_TRADE, 0, SPECIES_MILOTIC_SEVII, CONDITIONS({IF_HOLD_ITEM, ITEM_PRISM_SCALE})},
                                {EVO_ITEM, ITEM_PRISM_SCALE, SPECIES_MILOTIC_SEVII}),
    },

    [SPECIES_MILOTIC_SEVII] =
    {
        .baseHP        = 95,
        .baseAttack    = 60,
        .baseDefense   = 84,
        ...
        .weight = 1620,
        .description = COMPOUND_STRING(
            "The Sevii Islands form of Milotic.\n"
        ...
        .trainerScale = 360,
        .trainerOffset = 7,
        .frontPic = gMonFrontPic_MiloticSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        .frontAnimDelay = 45,
        .backPic = gMonBackPic_MiloticSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 3,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = gMonPalette_MiloticSevii,
        .shinyPalette = gMonShinyPalette_MiloticSevii,
        .iconSprite = gMonIcon_MiloticSevii,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 12, SHADOW_SIZE_M)
        FOOTPRINT(Milotic)
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_1 + 1, SPECIES_CHIMECHO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_LAST_KISS, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_METANG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_METAGROSS}),
    },
