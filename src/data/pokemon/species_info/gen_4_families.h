...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_4 + 1, SPECIES_STARAPTOR}),
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_WORMADAM_PLANT, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 14, SPECIES_MOTHIM_PLANT, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_WORMADAM_SANDY, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 14, SPECIES_MOTHIM_SANDY, CONDITIONS({IF_GENDER, MON_MALE})}),
        .randomizerMode = MON_RANDOMIZER_INVALID
    },
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_WORMADAM_TRASH, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 14, SPECIES_MOTHIM_TRASH, CONDITIONS({IF_GENDER, MON_MALE})}),
        .randomizerMode = MON_RANDOMIZER_INVALID
    },
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ANALYTIC, ABILITY_GRASS_PELT, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SOLID_ROCK, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
    ...
    [SPECIES_WORMADAM_TRASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_WEAK_ARMOR, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
...
#define MOTHIM_SPECIES_INFO(rzMode)                                         \
    {                                                                       \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),                         \
        .abilities = { ABILITY_PROTEAN, ABILITY_NONE, ABILITY_TINTED_LENS },  \
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_NONE, ABILITY_VOLT_ABSORB },
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_LOPUNNY}),
    },
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2, SPECIES_PURUGLY}),
    },
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2 + 1, SPECIES_SKUNTANK}),
    },
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2 + 1, SPECIES_TOXICROAK}),
    },
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_GRASS_PELT, ABILITY_INTIMIDATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2, SPECIES_LUMINEON}),
    },
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_4 + 1, SPECIES_ABOMASNOW}),
    },
