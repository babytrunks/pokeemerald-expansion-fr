...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_MERCILESS, ABILITY_NO_GUARD, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_TOGETIC}),
    },
    ...
    [SPECIES_NATU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2, SPECIES_XATU}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset, rzMode)   \
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 46, SPECIES_GLISCOR, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    #endif
    },
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_GRANBULL}),
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_WEAVILE, CONDITIONS({IF_TIME, TIME_NIGHT})})
    #endif
    },
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .formSpeciesIdTable = sSneaselFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SNEASLER, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_TEDDIURSA_SEVII] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GUTS, ABILITY_QUICK_FEET, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Teddiursa"),
        .cryId = CRY_TEDDIURSA,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_TeddiursaSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_TeddiursaSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = gMonPalette_TeddiursaSevii,
        .shinyPalette = gMonShinyPalette_TeddiursaSevii,
        .iconSprite = gMonIcon_TeddiursaSevii,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-2, 1, SHADOW_SIZE_S)
        FOOTPRINT(Teddiursa)
    ...
    [SPECIES_URSARING_SEVII] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_UrsaringSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = gMonBackPic_UrsaringSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_UrsaringSevii,
        .shinyPalette = gMonShinyPalette_UrsaringSevii,
        .iconSprite = gMonIcon_UrsaringSevii,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 14, SHADOW_SIZE_L)
        FOOTPRINT(Ursaring)
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_MANTYKE_SEVII] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STATIC, ABILITY_STORM_DRAIN, ABILITY_HYDRATION }, 
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Mantyke"),
        .cryId = CRY_MANTYKE,
        .natDexNum = NATIONAL_DEX_MANTYKE,
        ...
        .description = COMPOUND_STRING(
            ...
            "from the mainland variety, shaped by the\n"
            "islands' distinct environment."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MantykeSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_TWIST_TWICE,
        .backPic = gMonBackPic_MantykeSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = gMonPalette_MantykeSevii,
        .shinyPalette = gMonShinyPalette_MantykeSevii,
        .iconSprite = gMonIcon_MantykeSevii,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 3, SHADOW_SIZE_S)
        FOOTPRINT(Mantyke)
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MANTINE_SEVII, CONDITIONS({IF_SPECIES_IN_PARTY, SPECIES_REMORAID})},
                      {EVO_LEVEL, 30, SPECIES_MANTINE_SEVII}),
    },
#endif //P_GEN_4_CROSS_EVOS

    [SPECIES_MANTINE_SEVII] =
    {
        .baseHP        = 80,
        .baseAttack    = 30,
        .baseDefense   = 70,
        ...
        .trainerScale = 342,
        .trainerOffset = 7,
        .frontPic = gMonFrontPic_MantineSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_SWING_CONVEX,
        .backPic = gMonBackPic_MantineSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = gMonPalette_MantineSevii,
        .shinyPalette = gMonShinyPalette_MantineSevii,
        .iconSprite = gMonIcon_MantineSevii,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 8, SHADOW_SIZE_M)
        FOOTPRINT(Mantine)
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_REGENERATOR, ABILITY_PHOENIX_DOWN },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
