...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_DARTRIX}),
    },
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_4, SPECIES_DECIDUEYE, CONDITIONS({IF_TIME, TIME_DAY})},
                                {EVO_LEVEL, LEVEL_CAP_GYM_4, SPECIES_DECIDUEYE_HISUI, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_GUMSHOOS, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_WISHIWASHI_SOLO_SEVII] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_WishiwashiSoloSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 18,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE_SMALL,
        .enemyMonElevation = 12,
        .backPic = gMonBackPic_WishiwashiSoloSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 18,
        .palette = gMonPalette_WishiwashiSoloSevii,
        .shinyPalette = gMonShinyPalette_WishiwashiSoloSevii,
        .iconSprite = gMonIcon_WishiwashiSoloSevii,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 3, SHADOW_SIZE_S)
        FOOTPRINT(Wishiwashi)
        .levelUpLearnset = sWishiwashiSeviiLevelUpLearnset,
        .teachableLearnset = sWishiwashiSeviiTeachableLearnset,
        .eggMoveLearnset = sWishiwashiEggMoveLearnset,
        .formSpeciesIdTable = sWishiwashiFormSpeciesIdTable,
        .formChangeTable = sWishiwashiSeviiFormChangeTable,
        .randomizerMode = MON_RANDOMIZER_INVALID,
    },
    ...
    [SPECIES_WISHIWASHI_SCHOOL_SEVII] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_WishiwashiSchoolSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_WishiwashiSchoolSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .palette = gMonPalette_WishiwashiSchoolSevii,
        .shinyPalette = gMonShinyPalette_WishiwashiSchoolSevii,
        .iconSprite = gMonIcon_WishiwashiSchoolSevii,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-4, 7, SHADOW_SIZE_L)
        FOOTPRINT(Wishiwashi)
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_3 + 1, SPECIES_MUDSDALE}),
    },
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, LEVEL_CAP_GYM_2, SPECIES_SHIINOTIC}),
    },
    ...
    [SPECIES_TYPE_NULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_SILVALLY_NORMAL}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_DHELMISE_SEVII] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_GOOEY, ABILITY_TINTED_LENS }, 
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Dhelmise"),
        .cryId = CRY_DHELMISE,
        ...
        .trainerScale = 510,
        .trainerOffset = 11,
        .frontPic = gMonFrontPic_DhelmiseSevii,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_SWING_CONVEX,
        .enemyMonElevation = 2,
        .backPic = gMonBackPic_DhelmiseSevii,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 3,
        .palette = gMonPalette_DhelmiseSevii,
        .shinyPalette = gMonShinyPalette_DhelmiseSevii,
        .iconSprite = gMonIcon_DhelmiseSevii,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 12, SHADOW_SIZE_M)
        FOOTPRINT(Dhelmise)
        .levelUpLearnset = sDhelmiseSeviiLevelUpLearnset,
        .teachableLearnset = sDhelmiseSeviiTeachableLearnset,
        .formSpeciesIdTable = sDhelmiseFormSpeciesIdTable,
    },
