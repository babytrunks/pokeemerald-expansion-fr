...
#if P_COSPLAY_PIKACHU_FORMS || P_CAP_PIKACHU_FORMS
// Shared by every costumed Pikachu form so the Pika Wardrobe can freely swap between them.
static const struct FormChange sPikachuWardrobeFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_COSPLAY,   ITEM_PIKA_WARDROBE, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_ROCK_STAR, ITEM_PIKA_WARDROBE, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_BELLE,     ITEM_PIKA_WARDROBE, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_POP_STAR,  ITEM_PIKA_WARDROBE, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_PHD,       ITEM_PIKA_WARDROBE, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_LIBRE,     ITEM_PIKA_WARDROBE, 5},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_SURFING,   ITEM_PIKA_WARDROBE, 6},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_FLYING,    ITEM_PIKA_WARDROBE, 7},
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_COSPLAY_PIKACHU_FORMS || P_CAP_PIKACHU_FORMS
...
static const struct FormChange sDarmanitanFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_ZEN,      ABILITY_ZEN_MODE, HP_HIGHER_THAN, 0},
...
static const struct FormChange sDarmanitanGalarFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_GALAR_ZEN,      ABILITY_ZEN_MODE, HP_HIGHER_THAN, 0},
...
static const struct FormChange sWishiwashiSeviiFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_WISHIWASHI_SCHOOL_SEVII, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_WISHIWASHI_SOLO_SEVII,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_WISHIWASHI_SOLO_SEVII},
    {FORM_CHANGE_FAINT,             SPECIES_WISHIWASHI_SOLO_SEVII},
    {FORM_CHANGE_END_BATTLE,        SPECIES_WISHIWASHI_SOLO_SEVII},
    {FORM_CHANGE_TERMINATOR},
};
