...
static const struct LevelUpMove sVenusaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(LEVEL_CAP_BADGE_8, MOVE_GROWTH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBlastoiseLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(70, MOVE_SHELL_SMASH), // COMMENT: No idea when E4 is, but this should be right before E4, or VR
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVolcaronaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(54, MOVE_QUIVER_DANCE), // COMMENT come back to this ? 
