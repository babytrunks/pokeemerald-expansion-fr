...
const u32 gTrainerFrontPic_RgbyRed[] = INCBIN_U32("graphics/trainers/front_pics/rgby_red.4bpp.smol");
const u16 gTrainerPalette_RgbyRed[] = INCBIN_U16("graphics/trainers/front_pics/rgby_red.gbapal");
...
const u32 gTrainerFrontPic_Kris[] = INCBIN_U32("graphics/trainers/front_pics/kris.4bpp.smol");
const u16 gTrainerPalette_Kris[] = INCBIN_U16("graphics/trainers/palettes/kris.gbapal");
...
const u16 gTrainerPaletteBack_Lyra[] = INCBIN_U16("graphics/trainers/palettes/lyra_back.gbapal");


const u32 gTrainerFrontPic_Alain[] = INCBIN_U32("graphics/trainers/front_pics/alain.4bpp.smol");
const u16 gTrainerPalette_Alain[] = INCBIN_U16("graphics/trainers/front_pics/alain.gbapal");

const u32 gTrainerFrontPic_PlainInsane[] = INCBIN_U32("graphics/trainers/front_pics/plaininsane.4bpp.smol");
const u16 gTrainerPalette_PlainInsane[] = INCBIN_U16("graphics/trainers/palettes/plaininsane.gbapal");

const u32 gTrainerFrontPic_Silva[] = INCBIN_U32("graphics/trainers/front_pics/silva.4bpp.smol");
const u16 gTrainerPalette_Silva[] = INCBIN_U16("graphics/trainers/palettes/silva.gbapal");
...
const u32 gTrainerFrontPic_Mina[] = INCBIN_U32("graphics/trainers/front_pics/mina.4bpp.smol");
const u16 gTrainerPalette_Mina[] = INCBIN_U16("graphics/trainers/front_pics/mina.gbapal");

const u32 gTrainerFrontPic_Coats[] = INCBIN_U32("graphics/trainers/front_pics/coats.4bpp.smol");
const u16 gTrainerPalette_Coats[] = INCBIN_U16("graphics/trainers/front_pics/coats.gbapal");

const u32 gTrainerFrontPic_Mde[] = INCBIN_U32("graphics/trainers/front_pics/mde.4bpp.smol");
const u16 gTrainerPalette_Mde[] = INCBIN_U16("graphics/trainers/front_pics/mde.gbapal");

const u32 gTrainerFrontPic_Elbein[] = INCBIN_U32("graphics/trainers/front_pics/elbein.4bpp.smol");
const u16 gTrainerPalette_Elbein[] = INCBIN_U16("graphics/trainers/front_pics/elbein.gbapal");

const u32 gTrainerFrontPic_Deno[] = INCBIN_U32("graphics/trainers/front_pics/deno.4bpp.smol");
const u16 gTrainerPalette_Deno[] = INCBIN_U16("graphics/trainers/front_pics/deno.gbapal");

const u32 gTrainerFrontPic_Pom[] = INCBIN_U32("graphics/trainers/front_pics/pom.4bpp.smol");
const u16 gTrainerPalette_Pom[] = INCBIN_U16("graphics/trainers/front_pics/pom.gbapal");
...
const u8 gTrainerBackPic_RgbyRed[] = INCBIN_U8("graphics/trainers/back_pics/rgby_red_back_pic.4bpp");
...
const u8 gTrainerBackPic_Alain[] = INCBIN_U8("graphics/trainers/back_pics/alain.4bpp");
...
const u16 gTrainerBackPicPalette_RgbyRed[] = INCBIN_U16("graphics/trainers/back_pics/rgby_red_back_pic.gbapal");
const u16 gTrainerBackPicPalette_Gold[] = INCBIN_U16("graphics/trainers/palettes/gold_back.gbapal");
const u16 gTrainerBackPicPalette_Kris[] = INCBIN_U16("graphics/trainers/palettes/kris_back.gbapal");
const u16 gTrainerBackPicPalette_Lance[] = INCBIN_U16("graphics/trainers/palettes/lance.gbapal");
// const u16 gTrainerBackPicPalette_Lucas[] = INCBIN_U16("graphics/trainers/palettes/lucas_back.gbapal");
// const u16 gTrainerBackPicPalette_Dawn[] = INCBIN_U16("graphics/trainers/palettes/dawn_back.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_YOUNGSTER_FRLG, gTrainerFrontPic_YoungsterFrlg, gTrainerPalette_YoungsterFrlg),
    TRAINER_SPRITE(TRAINER_PIC_BUG_CATCHER_FRLG, gTrainerFrontPic_BugCatcherFrlg, gTrainerPalette_BugCatcherFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LASS_FRLG, gTrainerFrontPic_LassFrlg, gTrainerPalette_LassFrlg),
    TRAINER_SPRITE(TRAINER_PIC_SAILOR_FRLG, gTrainerFrontPic_SailorFrlg, gTrainerPalette_SailorFrlg),
    TRAINER_SPRITE(TRAINER_PIC_CAMPER_FRLG, gTrainerFrontPic_CamperFrlg, gTrainerPalette_CamperFrlg),
    TRAINER_SPRITE(TRAINER_PIC_PICNICKER_FRLG, gTrainerFrontPic_PicnickerFrlg, gTrainerPalette_PicnickerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_POKEMANIAC_FRLG, gTrainerFrontPic_PokeManiacFrlg, gTrainerPalette_PokeManiacFrlg),
    TRAINER_SPRITE(TRAINER_PIC_SUPER_NERD_FRLG, gTrainerFrontPic_SuperNerdFrlg, gTrainerPalette_SuperNerdFrlg),
    TRAINER_SPRITE(TRAINER_PIC_HIKER_FRLG, gTrainerFrontPic_HikerFrlg, gTrainerPalette_HikerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_BIKER_FRLG, gTrainerFrontPic_BikerFrlg, gTrainerPalette_BikerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_BURGLAR_FRLG, gTrainerFrontPic_BurglarFrlg, gTrainerPalette_BurglarFrlg),
    TRAINER_SPRITE(TRAINER_PIC_ENGINEER_FRLG, gTrainerFrontPic_EngineerFrlg, gTrainerPalette_EngineerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FISHERMAN_FRLG, gTrainerFrontPic_FishermanFrlg, gTrainerPalette_FishermanFrlg),
    TRAINER_SPRITE(TRAINER_PIC_SWIMMER_M_FRLG, gTrainerFrontPic_SwimmerMFrlg, gTrainerPalette_SwimmerMFrlg),
    TRAINER_SPRITE(TRAINER_PIC_CUE_BALL_FRLG, gTrainerFrontPic_CueBallFrlg, gTrainerPalette_CueBallFrlg),
    TRAINER_SPRITE(TRAINER_PIC_GAMER_FRLG, gTrainerFrontPic_GamerFrlg, gTrainerPalette_GamerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_BEAUTY_FRLG, gTrainerFrontPic_BeautyFrlg, gTrainerPalette_BeautyFrlg),
    TRAINER_SPRITE(TRAINER_PIC_SWIMMER_F_FRLG, gTrainerFrontPic_SwimmerFFrlg, gTrainerPalette_SwimmerFFrlg),
    TRAINER_SPRITE(TRAINER_PIC_PSYCHIC_M_FRLG, gTrainerFrontPic_PsychicMFrlg, gTrainerPalette_PsychicMFrlg),
    TRAINER_SPRITE(TRAINER_PIC_ROCKER_FRLG, gTrainerFrontPic_RockerFrlg, gTrainerPalette_RockerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_JUGGLER_FRLG, gTrainerFrontPic_JugglerFrlg, gTrainerPalette_JugglerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_TAMER_FRLG, gTrainerFrontPic_TamerFrlg, gTrainerPalette_TamerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_BIRD_KEEPER_FRLG, gTrainerFrontPic_BirdKeeperFrlg, gTrainerPalette_BirdKeeperFrlg),
    TRAINER_SPRITE(TRAINER_PIC_BLACK_BELT_FRLG, gTrainerFrontPic_BlackBeltFrlg, gTrainerPalette_BlackBeltFrlg),
    TRAINER_SPRITE(TRAINER_PIC_RIVAL_EARLY_FRLG, gTrainerFrontPic_RivalEarlyFrlg, gTrainerPalette_RivalEarlyFrlg),
    TRAINER_SPRITE(TRAINER_PIC_SCIENTIST_FRLG, gTrainerFrontPic_ScientistFrlg, gTrainerPalette_ScientistFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_GIOVANNI_FRLG, gTrainerFrontPic_LeaderGiovanniFrlg, gTrainerPalette_LeaderGiovanniFrlg),
    TRAINER_SPRITE(TRAINER_PIC_ROCKET_GRUNT_M_FRLG, gTrainerFrontPic_RocketGruntMFrlg, gTrainerPalette_RocketGruntMFrlg),
    TRAINER_SPRITE(TRAINER_PIC_COOLTRAINER_M_FRLG, gTrainerFrontPic_CooltrainerMFrlg, gTrainerPalette_CooltrainerMFrlg),
    TRAINER_SPRITE(TRAINER_PIC_COOLTRAINER_F_FRLG, gTrainerFrontPic_CooltrainerFFrlg, gTrainerPalette_CooltrainerFFrlg),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_LORELEI_FRLG, gTrainerFrontPic_EliteFourLoreleiFrlg, gTrainerPalette_EliteFourLoreleiFrlg, -8, 0),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_BRUNO_FRLG, gTrainerFrontPic_EliteFourBrunoFrlg, gTrainerPalette_EliteFourBrunoFrlg, -10, 0),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_AGATHA_FRLG, gTrainerFrontPic_EliteFourAgathaFrlg, gTrainerPalette_EliteFourAgathaFrlg, 0, 0),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_LANCE_FRLG, gTrainerFrontPic_EliteFourLanceFrlg, gTrainerPalette_EliteFourLanceFrlg, -32, 0),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_BROCK_FRLG, gTrainerFrontPic_LeaderBrockFrlg, gTrainerPalette_LeaderBrockFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_MISTY_FRLG, gTrainerFrontPic_LeaderMistyFrlg, gTrainerPalette_LeaderMistyFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_LT_SURGE_FRLG, gTrainerFrontPic_LeaderLtSurgeFrlg, gTrainerPalette_LeaderLtSurgeFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_ERIKA_FRLG, gTrainerFrontPic_LeaderErikaFrlg, gTrainerPalette_LeaderErikaFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_KOGA_FRLG, gTrainerFrontPic_LeaderKogaFrlg, gTrainerPalette_LeaderKogaFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_BLAINE_FRLG, gTrainerFrontPic_LeaderBlaineFrlg, gTrainerPalette_LeaderBlaineFrlg),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_SABRINA_FRLG, gTrainerFrontPic_LeaderSabrinaFrlg, gTrainerPalette_LeaderSabrinaFrlg),
    TRAINER_SPRITE(TRAINER_PIC_GENTLEMAN_FRLG, gTrainerFrontPic_GentlemanFrlg, gTrainerPalette_GentlemanFrlg),
    TRAINER_SPRITE(TRAINER_PIC_RIVAL_LATE_FRLG, gTrainerFrontPic_RivalLateFrlg, gTrainerPalette_RivalLateFrlg),
    TRAINER_SPRITE(TRAINER_PIC_CHAMPION_RIVAL_FRLG, gTrainerFrontPic_ChampionRivalFrlg, gTrainerPalette_ChampionRivalFrlg, 0, 0),
    TRAINER_SPRITE(TRAINER_PIC_CHANNELER_FRLG, gTrainerFrontPic_ChannelerFrlg, gTrainerPalette_ChannelerFrlg),
    TRAINER_SPRITE(TRAINER_PIC_TWINS_FRLG, gTrainerFrontPic_TwinsFrlg, gTrainerPalette_TwinsFrlg),
    TRAINER_SPRITE(TRAINER_PIC_COOL_COUPLE_FRLG, gTrainerFrontPic_CoolCoupleFrlg, gTrainerPalette_CoolCoupleFrlg),
    TRAINER_SPRITE(TRAINER_PIC_YOUNG_COUPLE_FRLG, gTrainerFrontPic_YoungCoupleFrlg, gTrainerPalette_YoungCoupleFrlg),
    TRAINER_SPRITE(TRAINER_PIC_CRUSH_KIN_FRLG, gTrainerFrontPic_CrushKinFrlg, gTrainerPalette_CrushKinFrlg),
    TRAINER_SPRITE(TRAINER_PIC_SIS_AND_BRO_FRLG, gTrainerFrontPic_SisAndBroFrlg, gTrainerPalette_SisAndBroFrlg),
    TRAINER_SPRITE(TRAINER_PIC_PROFESSOR_OAK_FRLG, gTrainerFrontPic_ProfessorOakFrlg, gTrainerPalette_ProfessorOakFrlg),
    TRAINER_SPRITE(TRAINER_PIC_ROCKET_GRUNT_F_FRLG, gTrainerFrontPic_RocketGruntFFrlg, gTrainerPalette_RocketGruntFFrlg),
    TRAINER_SPRITE(TRAINER_PIC_PSYCHIC_F_FRLG, gTrainerFrontPic_PsychicFFrlg, gTrainerPalette_PsychicFFrlg),
    TRAINER_SPRITE(TRAINER_PIC_CRUSH_GIRL_FRLG, gTrainerFrontPic_CrushGirlFrlg, gTrainerPalette_CrushGirlFrlg),
    TRAINER_SPRITE(TRAINER_PIC_TUBER_F_FRLG, gTrainerFrontPic_TuberFFrlg, gTrainerPalette_TuberFFrlg),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_BREEDER_FRLG, gTrainerFrontPic_PokemonBreederFrlg, gTrainerPalette_PokemonBreederFrlg),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_RANGER_M_FRLG, gTrainerFrontPic_PokemonRangerMFrlg, gTrainerPalette_PokemonRangerMFrlg),
    TRAINER_SPRITE(TRAINER_PIC_POKEMON_RANGER_F_FRLG, gTrainerFrontPic_PokemonRangerFFrlg, gTrainerPalette_PokemonRangerFFrlg),
    TRAINER_SPRITE(TRAINER_PIC_AROMA_LADY_FRLG, gTrainerFrontPic_AromaLadyFrlg, gTrainerPalette_AromaLadyFrlg),
    ...
    TRAINER_SPRITE(TRAINER_PIC_RGBY_RED, gTrainerFrontPic_RgbyRed, gTrainerPalette_RgbyRed),
    ...
    TRAINER_SPRITE(TRAINER_PIC_ALAIN, gTrainerFrontPic_Alain, gTrainerPalette_Alain),
    ...
    TRAINER_SPRITE(TRAINER_PIC_COATS, gTrainerFrontPic_Coats, gTrainerPalette_Coats),
    TRAINER_SPRITE(TRAINER_PIC_MDE, gTrainerFrontPic_Mde, gTrainerPalette_Mde),
    TRAINER_SPRITE(TRAINER_PIC_ELBEIN, gTrainerFrontPic_Elbein, gTrainerPalette_Elbein),
    TRAINER_SPRITE(TRAINER_PIC_DENO, gTrainerFrontPic_Deno, gTrainerPalette_Deno),
    TRAINER_SPRITE(TRAINER_PIC_POM, gTrainerFrontPic_Pom, gTrainerPalette_Pom),
};
...
// Sequential Kanto-style throw for back pics that only have 4 frames
// (sAnimCmd_Kanto references frame 4, which requires a 5-frame sprite).
static const union AnimCmd sAnimCmd_Kanto4Frames[] =
{
    ANIMCMD_FRAME(1, 20),
    ANIMCMD_FRAME(2, 6),
    ANIMCMD_FRAME(3, 6),
...
static const union AnimCmd *const sBackAnims_Kanto4Frames[] =
{
    sAnim_GeneralFrame0 ,
    sAnimCmd_Kanto4Frames,
    sAnimCmd_Point_HGSS_Red_Leaf,
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_POKEDUDE, 4, gTrainerBackPic_Pokedude, gTrainerBackPicPalette_Pokedude, sBackAnims_OldManPokedude),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_OLD_MAN, 4, gTrainerBackPic_OldMan, gTrainerBackPicPalette_OldMan, sBackAnims_OldManPokedude),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_RGBY_RED, 4, gTrainerBackPic_RgbyRed, gTrainerBackPicPalette_RgbyRed, sBackAnims_Kanto4Frames),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_GOLD, 5, gTrainerBackPic_Gold, gTrainerBackPicPalette_Gold, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_KRIS, 4, gTrainerBackPic_Kris, gTrainerBackPicPalette_Kris, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_LUCAS, 4, gTrainerBackPic_Lucas, gTrainerPalette_Lucas, sBackAnims_Kanto4Frames),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_DAWN, 4, gTrainerBackPic_Dawn, gTrainerPalette_Dawn, sBackAnims_Kanto4Frames),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_GREEN, 4, gTrainerBackPic_Green, gTrainerPalette_Green, sBackAnims_Kanto4Frames),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_LYRA, 4, gTrainerBackPic_Lyra, gTrainerPaletteBack_Lyra, sBackAnims_Kanto4Frames),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_ALAIN, 4, gTrainerBackPic_Alain, gTrainerPalette_Alain, sBackAnims_Kanto4Frames),
