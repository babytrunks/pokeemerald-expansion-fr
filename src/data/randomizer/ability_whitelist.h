...
static const u16 sRandomizerAbilityWhitelist[] =
{
    ...
    ABILITY_FROZEN_MIST, //shield dust buff
    ABILITY_BLUBBER_DEFENSE, //multiscale lul
    ABILITY_CASH_SPLASH, // water bubble for whiscash
    ABILITY_MEGA_SOL,
    ABILITY_DRAGONIZE,
    ABILITY_FIRE_MANE,
    ABILITY_EELEVATE,
    ABILITY_CORROSIVE_GUTS, // Corrosion + Innards Out
    ABILITY_LAST_KISS, // Healing Wish + revival on faint, once per battle per side
};
