...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_BLIZZARD] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits foes with an icy\n"
            "storm. 10% to frostbite."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 110 : 120,
        .type = TYPE_ICE,
        .accuracy = 70,
    ...
    [MOVE_AURORA_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires a rainbow beam with\n"
            "a 10% to lower Attack."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_SKY_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            "2-turn attack. High crit\n"
            "ratio, and 30% to flinch."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 140,
        .type = TYPE_FLYING,
        .accuracy = 90,
    ...
    [MOVE_TRI_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires three beams. 20% to\n"
            "burn, paralyze or frostbite."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_POWDER_SNOW] =
    {
        ...
        .description = COMPOUND_STRING(
            "Blasts foes with a snowy\n"
            "gust. 10% to frostbite."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_BREATH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes with a blast of\n"
            "breath. 30% to paralyze."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_ANCIENT_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack with a 10% to\n"
            "raise all of user's stats."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_SILVER_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powdery attack with a\n"
            "10% to raise all stats."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_JOVIAL_BASH] =
    {
        .name = COMPOUND_STRING("Jovial Bash"),
        .description = COMPOUND_STRING(
            "Cutely tackles the foe.\n"
            "20% to infatuate."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FAIRY,
    ...
    [MOVE_THUNDER_FANG] =
    {
        ...
        .description = COMPOUND_STRING(
            "Bites with an electric jolt.\n"
            "10% flinch, 10% paralyze."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_HEART_STAMP] =
    {
        ...
        .description = COMPOUND_STRING(
            "A sudden blow after a\n"
            "cute act. 30% to flinch."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_NIGHT_DAZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Looses a pitch-black wave.\n"
            "40% to lower accuracy."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_HEAD_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A strong charge. Hurts the\n"
            "user. 10% to lower Def."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_TOXIC_THREAD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "poisons and harshly drops Speed."),
    ...
    [MOVE_SHELL_SIDE_ARM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Deals better of phys and\n"
            "spec damage. 20% poison."),
    ...
    [MOVE_SPRINGTIDE_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Wraps a foe in fierce\n"
            "winds. 30% to lower Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .description = COMPOUND_STRING(
            "High crit ratio. 50% to\n"
            "lower Def, 30% to flinch."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SALT_CURE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hurts foe for 1/16 every turn. Double\n"
    ...
    [MOVE_BREAKTHROUGH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Adds 10 IVs to a random offensive\nstat for the user upon KO\nin a trainer battle."),
    ...
    [MOVE_FORTIFY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Adds 10 IVs to a random defensive\nstat for the user upon KO\nin a trainer battle."),
