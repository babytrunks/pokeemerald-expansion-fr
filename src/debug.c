...
static const struct DebugMenuOption sDebugMenu_Actions_Scripts[] =
{
    ...
    { COMPOUND_STRING("Tag Battle Test"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
...
{
    ZeroPlayerPartyMons();
    CreateNPCTrainerPartyFromTrainer(gPlayerParty, &sDebugTrainers[DIFFICULTY_NORMAL][DEBUG_TRAINER_PLAYER], TRUE, BATTLE_TYPE_TRAINER, 0, 0);
    ScriptContext_Enable();
    Debug_DestroyMenu_Full(taskId);
}
...
static void DebugAction_Party_BattleSingle(u8 taskId)
{
    ...
    ZeroEnemyPartyMons();
    CreateNPCTrainerPartyFromTrainer(gPlayerParty, &sDebugTrainers[DIFFICULTY_NORMAL][DEBUG_TRAINER_PLAYER], TRUE, BATTLE_TYPE_TRAINER, 0, 0);
    CreateNPCTrainerPartyFromTrainer(gEnemyParty, GetDebugAiTrainer(), FALSE, BATTLE_TYPE_TRAINER, 0, 0);
