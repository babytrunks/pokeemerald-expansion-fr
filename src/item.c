...
void SetBagItemsPointers(void)
{
    ...
    gBagPockets[POCKET_POWER_UP].itemSlots = gSaveBlock1Ptr->bag.medicine;
    gBagPockets[POCKET_POWER_UP].capacity = BAG_POWER_UP_COUNT;
    ...
    gBagPockets[POCKET_MEGA_STONES].itemSlots = gSaveBlock1Ptr->bag.treasures;
    gBagPockets[POCKET_MEGA_STONES].capacity = BAG_TREASURES_COUNT;
}
