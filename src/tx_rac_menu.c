...
static const u8 sText_Description_Random_Moves_Off[]                = _("Pokémon learnsets stay the same as in\nthe base game.");
static const u8 sText_Description_Random_Moves_On[]                 = _("Randomize Pokémon learnsets.");
