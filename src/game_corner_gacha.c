...
#define RARITY_COMMON_ODDS 100
#define RARITY_UNCOMMON_ODDS 0
#define RARITY_RARE_ODDS 0
#define RARITY_ULTRA_RARE_ODDS 0

// updated here
#define GACHA_BASIC_MIN_WAGER 1
#define GACHA_GREAT_MIN_WAGER 2
#define GACHA_ULTRA_MIN_WAGER 5
#define GACHA_MASTER_MIN_WAGER 10 
...
static const u16 sGachaBasicSpeciesUncommon[] = { //unused dd
    SPECIES_UNOWN,
};

static const u16 sGachaGreatSpeciesRare[] = { // unused
    SPECIES_SHUCKLE
};

static const u16 sGachaBasicSpeciesRare[] = { // unused
    SPECIES_RALTS,
};

static const u16 sGachaBasicSpeciesUltraRare[] = {// unused 
    SPECIES_TOGEPI,
};

static const u16 sGachaUltraSpeciesUncommon[] = { //unused
    SPECIES_DELIBIRD
};


static const u16 sGachaGreatSpeciesUncommon[] = { //unused
    SPECIES_UNOWN,
};

static const u16 sGachaUltraSpeciesRare[] = { // unused
    SPECIES_DITTO
};

static const u16 sGachaUltraSpeciesUltraRare[] = {// unused
    SPECIES_SHEDINJA
};

static const u16 sGachaGreatSpeciesUltraRare[] = { // unused
...
static const u16 sGachaMasterSpeciesUncommon[] = { // unused
    SPECIES_OMASTAR,
};

static const u16 sGachaMasterSpeciesRare[] = { // unused
    SPECIES_ARTICUNO,
};

static const u16 sGachaMasterSpeciesUltraRare[] = {// unused
    SPECIES_MEW
};
...
static void GachaMain(u8 taskId)
{
    ...
    case STATE_INIT_A: // Initial state
        ...
        PlaySE(SE_SHOP);
        RemoveBagItem(ITEM_GACHA_VOUCHER,sGacha->wager);
        sGacha->wager = 0;
        ResetMessage();
        gSprites[sGacha->CTAspriteId].animNum = 0;
        gSprites[sGacha->ArrowsSpriteId].invisible = TRUE;
        SetCreditDigits(CountTotalItemQuantityInBag (ITEM_GACHA_VOUCHER)); //updated here
...
static bool32 GachaGfxSetup(void)
{
    ...
    case 3:
        ...
        CreateCreditSprites();
        CreatePlayerSprites();
        SetCreditDigits(CountTotalItemQuantityInBag (ITEM_GACHA_VOUCHER));
        SetPlayerDigits(0);    
        CreateCreditMenu();    
        CreatePlayerMenu();
        CreateLotteryJPN();
