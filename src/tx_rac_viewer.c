...
//Page 1
static u8 GetSel_InfiniteTMs(void)        { return FALSE; }
static u8 GetSel_SurvivePoison(void)      { return FALSE; }
static u8 GetSel_Synchronize(void)        { return FALSE; }
static u8 GetSel_Mints(void)              { return FALSE; }
static u8 GetSel_NewCitrus(void)          {return FALSE; }
static u8 GetSel_FairyTypes(void)         { return FALSE; }
static u8 GetSel_Sturdy(void)             { return FALSE; }
static u8 GetSel_ModernMoves(void)        { return FALSE;}
static u8 GetSel_LegendaryAbilities(void) { return FALSE; }

//Page 2
static u8 GetSel_Feature_RTCType(void)      { return FALSE;}
static u8 GetSel_Feature_ShinyChance(void)  { return FALSE; }
static u8 GetSel_Feature_ItemDrops(void)    { return FALSE; }
static u8 GetSel_Feature_FrontierBans(void) { return FALSE; } //reversed from the rest
static u8 GetSel_Feature_ShinyColors(void)  { return FALSE; }
...
static u8 GetSel_Rand_Starter(void)        { return FALSE; }
static u8 GetSel_Rand_Wild(void)           { return FALSE; }
static u8 GetSel_Rand_Trainer(void)        { return FALSE; }
static u8 GetSel_Rand_Static(void)         { return FALSE; }
// Similar Evo Level is defined as the inverse in the menu: sel = !tx_Random_Similar
static u8 GetSel_Rand_SimilarEvoLvl(void)  { return FALSE; }
static u8 GetSel_Rand_IncludeLegends(void) { return FALSE; }
static u8 GetSel_Rand_Type(void)           { return FALSE; }
static u8 GetSel_Rand_Moves(void)          { return FALSE; }
static u8 GetSel_Rand_Abilities(void)      { return FALSE; }
static u8 GetSel_Rand_Evolutions(void)     { return FALSE; }
static u8 GetSel_Rand_EvoMethods(void)     { return FALSE; }
static u8 GetSel_Rand_TypeEffect(void)     { return FALSE; }
static u8 GetSel_Rand_Items(void)          { return FALSE; }
static u8 GetSel_Rand_Chaos(void)          { return FALSE; }

// Page 4 (Nuzlocke) getters
// Returns 0=OFF, 1=EASY, 2=STANDARD, 3=HARDCORE based on how the menu writes the flags
static u8 GetNuzlockeModeIndex(void)       { return 0; }
static u8 GetSel_Nuz_Nuzlocke(void)        { return FALSE; }
static u8 GetSel_Nuz_Hardcore(void)        { return FALSE; }
static u8 GetSel_Nuz_SpeciesClause(void)   { return FALSE; }
static u8 GetSel_Nuz_ShinyClause(void)     { return FALSE; }
static u8 GetSel_Nuz_Nicknaming(void)      { return FALSE; }
static u8 GetSel_Nuz_Deletion(void)        { return FALSE; }
static u8 GetSel_Nuz_RareCandy(void)       { return FALSE; }

// ---- Page 5 getters ----
// Multi-choice rows
static u8 GetSel_Diff_PartyLimit(void)      { return 0; }      // 0..5 (OFF,5,4,3,2,1)
static u8 GetSel_Diff_LevelCap(void)        { return 0; }        // 0..2 (Off, Easy, Hard)
static u8 GetSel_Diff_ExpMult(void)         { return 0; }   // 0..3 (1x,1.5x,2x,0x)
static u8 GetSel_Diff_PlayerIVs(void)       { return 0; }     //0..2 (Yes, No, No(HP))
static u8 GetSel_Diff_TrainerIVs(void)      { return 0; } // 0..2 (Off, Scale, Hard)
static u8 GetSel_Diff_TrainerEVs(void)      { return 0; } // 0..3 (Off, Scale, Hard, Extreme)

// Plain bool rows (normalize to 0/1 for the shared bool renderer)
static u8 GetSel_Diff_NoItemPlayer(void)    { return FALSE; } //Yes/No
static u8 GetSel_Diff_NoItemTrainer(void)   { return FALSE; } //Yes/No
static u8 GetSel_Diff_PlayerEVs(void)       { return FALSE; } //Yes/No
static u8 GetSel_Diff_EscapeRopeDig(void)   { return FALSE; } //Inverted
static u8 GetSel_Diff_LessEscapes(void)     { return FALSE; } //Yes/No

// ---- Page 6 getters ----
// Multi-choice rows return raw index; bool rows return 0/1
static u8 GetSel_Chk_PkmnCenter(void)      { return FALSE; }
static u8 GetSel_Chk_PCHeal(void)          { return FALSE; }

// Expensive (0..3) => OFF, 5X, 10X, 50X
static u8 GetSel_Chk_Expensive(void)       { return 0; }

// Evo Limit (0..2) => OFF, FIRST, ALL
static u8 GetSel_Chk_EvoLimit(void)        { return 0; }

static u8 GetSel_Chk_OneType(void)         { return FALSE; }

// Base Stat Equalizer (0..3) => OFF, 100, 255, 500
static u8 GetSel_Chk_BaseStatEq(void)      { return 0; }

static u8 GetSel_Chk_Mirror(void)          { return FALSE; }
static u8 GetSel_Chk_MirrorThief(void)     { return FALSE; }
...
static void Viewer_DrawRow_Page6(u8 visRow, u16 idx)
{
    ...
    {
        u8 v = 19; // placeholder: display OFF
