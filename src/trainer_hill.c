...
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM_SUPERCELL_SLAM,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListSkillSwap[]   = {ITEM_TM_ELECTROWEB,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
