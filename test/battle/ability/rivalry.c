...
SINGLE_BATTLE_TEST("Rivalry does 1x towards Pokémon of different gender", s16 damage)
{
    ...
    GIVEN {
        ...
        EXPECT_MUL_EQ(results[0].damage, Q_4_12(1), results[1].damage);
        EXPECT_MUL_EQ(results[2].damage, Q_4_12(1), results[3].damage);
    }
}
